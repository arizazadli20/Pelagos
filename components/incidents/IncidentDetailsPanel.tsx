...
function generateIncidentPdf(
  ...
  line("Pelagos — Incident Response Report", 18, true, 10);
  ...
  doc.text(
    "Demo document generated by Pelagos — a mock oil-spill intelligence platform. Figures are simulated.",
    14,
    285
  );

  doc.save(`pelagos-incident-${incident.displayId.replace("#", "")}-report.pdf`);
}
